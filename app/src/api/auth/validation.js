...
export const verifyTokenValidationSchema = Joi.object({
...
export const requestTokenTwitterSchema = Joi.object({
    callbackUrl: Joi.string().uri().required(),
});

export const verifyTokenTwitterSchema = Joi.object({
    oauth_token: Joi.string().required(),
    oauth_verifier: Joi.string().required(),
    userTimezoneOffset: Joi.number().required(),
});
